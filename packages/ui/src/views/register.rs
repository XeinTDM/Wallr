    ...
    rsx! {
        div {
            ...
            div {
                ...
                h2 { style: "font-size: 32px; font-weight: 900; margin-bottom: 8px;", "{i18n.t(\"join_wallr\")}" }
                p { style: "color: var(--text-secondary); margin-bottom: 40px;", "{i18n.t(\"register_subtitle\")}" }
                ...
                div {
                    ...
                    a {
                        ...
                        class: "glass glow-hover",
                        style: "padding: 16px; border-radius: 16px; display: flex; align-items: center; justify-content: center; gap: 12px; font-weight: 700; color: white; border: 1px solid rgba(255,255,255,0.1); background: rgba(255,255,255,0.05); text-decoration: none; cursor: pointer; transition: all 0.2s ease;",
                        lucide_dioxus::GitBranch { size: 20 }
                    ...
                    a {
                        ...
                        class: "glass glow-hover",
                        style: "padding: 16px; border-radius: 16px; display: flex; align-items: center; justify-content: center; gap: 12px; font-weight: 700; color: white; border: 1px solid rgba(255,255,255,0.1); background: rgba(255,255,255,0.05); text-decoration: none; cursor: pointer; transition: all 0.2s ease;",
                        lucide_dioxus::MessageSquare { size: 20 }
                ...
                form {
                    ...
                    onsubmit: on_submit,
                    div {
                        label { style: "display: block; margin-bottom: 8px; font-size: 14px; font-weight: 600;", "{i18n.t(\"full_name\")}" }
                        input {
                            class: "glass",
                    ...
                    div {
                        label { style: "display: block; margin-bottom: 8px; font-size: 14px; font-weight: 600;", "{i18n.t(\"password\")}" }
                        input {
                            r#type: "password",
                            class: "glass",
                            style: "width: 100%; padding: 14px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.1); background: rgba(255,255,255,0.05); color: white;",
                    ...
                    button {
                        ...
                        disabled: is_loading(),
                        UserPlus { size: 20 }
                        if is_loading() { "{i18n.t(\"creating_account\")}" } else { "{i18n.t(\"create_an_account\")}" }
                    }
                }
                ...
                p {
                    ...
                    Link { to: Route::Login {}, style: "color: var(--accent-primary); font-weight: 700;", "{i18n.t(\"sign_in\")}" }
                }
            }
        }
    }
